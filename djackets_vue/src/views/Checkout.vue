        ...
        <div class="columns is-multiline">
          ...
          <div class="column is-6">
            ...
            <div class="field">
              <label>Place*</label>
              <div class="control">
                <input type="email" class="input" v-model="place" required />
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    if (this.cartTotalLength > 0) {
      this.stripe = Stripe(
        "pk_test_51SETR34FuJ7yAyd3GjPPvOvZKr3fDsEdJxnc6V4vGBNzRtbLaiXB2x98SS2pvAVaovIyTOvcHGYeW4qVwZbZdHKP00FmsHxDKI"
      );
  ...
  methods: {
    ...
    submitForm() {
      ...
      if (this.email === "") this.errors.push("E-mail is required.");
      ...
      if (!this.errors.length) {
        ...
        this.stripe.createToken(this.card).then((result) => {
          if (result.error) {
            ...
            this.errors.push(
              "Something went wrong with this.stripe. Please try again"
            );
